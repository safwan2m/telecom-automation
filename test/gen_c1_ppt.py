...
steps = [
    ...
    ('10', 'Gemini LLM',   'Counts the length of the cells[] array in the response'),
    ('11', 'Gemini LLM',   'Generates natural language answer: "There are 30 cells deployed in the network."'),
